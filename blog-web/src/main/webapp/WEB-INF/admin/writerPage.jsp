        ...
        <div class="right_col" role="main">
			...
			<form id="articleForm">
				<div class="form-group col-md-6" style="padding: 0 10px 0 30px;">
					<input class="form-control" placeholder="请输入页面标题(必须)" id="pName" name="pName" required value=""/>
				</div>
				
				<div class="form-group col-md-6" style="padding: 0 10px 0 30px;">
					<input class="form-control" placeholder="请输入页面访问名(必须)" id="pPath" name="pPath" required value=""/>
				</div>
	...
	<script type="text/javascript">
			...
			var testEditor =null;
  			...
  			function save(state){
		        ...
		        var url = "${pageContext.request.contextPath}/admin/pageSave.action";
		        var data = {
		        			"pName":pName,
		        			"pPath":pPath,
		        			"pContent":pContent,
