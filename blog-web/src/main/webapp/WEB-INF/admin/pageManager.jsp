        ...
        <div class="right_col" role="main">
			...
			<div class="col-md-12">
		        <div class="pull-right">
		            <a href="${pageContext.request.contextPath}/admin/page/writerPage.action" class="btn btn-success waves-effect waves-light m-b-5">添加新页面</a>
		        </div>
		            ...
		            <tbody>
		          	<c:forEach items="${requestScope.pages}" var="page">
						<tr cid="3">
			                <td>${page.pName}</td>
			                <td>${page.pPath}</td>
			                <td><fmt:formatDate value="${page.pCreatetime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
			                <td>
			                    ${page.pState == '0' ? '发布':'草稿'}
			                </td>
			                <td>
			                    <a href="${pageContext.request.contextPath}/admin/toPageUpdate.action?pageId=${page.pId}" class="btn btn-primary btn-sm waves-effect waves-light m-b-5"><i
			                            class="fa fa-edit"></i> <span>编辑</span></a>
			                    <a href="${pageContext.request.contextPath}/admin/deletePage.action?pageId=${page.pId}"
			                       class="btn btn-danger btn-sm waves-effect waves-light m-b-5"><i
			                            class="fa fa-trash-o"></i> <span>删除</span></a>
			                    <a class="btn btn-warning btn-sm waves-effect waves-light m-b-5" href="${pageContext.request.contextPath}/admin/showPage.action?path=${page.pPath}"
			                       target="_blank"><i
