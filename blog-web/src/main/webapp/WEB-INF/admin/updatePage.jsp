    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
			...
			<div class="col-sm-12">
				<h4 class="page-title">发布页面</h4>
			</div>
			<form id="articleForm">
				<div class="form-group col-md-6" style="padding: 0 10px 0 30px;">
					<input type="hidden" id="pId" name="pId" value="${requestScope.page.pId}"/>
					<input type="hidden" id="pCreatetime" name="pCreatetime" value="${requestScope.page.pCreatetime}"/>
					<input class="form-control" placeholder="请输入页面标题(必须)" id="pName" name="pName" required value="${requestScope.page.pName}"/>
				</div>
				
				<div class="form-group col-md-6" style="padding: 0 10px 0 30px;">
					<input class="form-control" placeholder="请输入页面访问名(必须)" id="pPath" name="pPath" required value="${requestScope.page.pPath}"/>
				</div>
            	...
            	<div id="html-container" class="form-group col-md-12" style="padding:0 10px 0 30px" >
            		 <div class="editormd"  id="test-editormd">
					    <textarea class="editormd-markdown-textarea" name="eContent" id="editormd">${requestScope.page.pContent}</textarea>
	...
	<script type="text/javascript">
			...
			var testEditor =null;
  			...
  			function update(state){
  				var pContent =null;
  				if(f){
  	  				pContent = testEditor.getMarkdown();
  				}else{
  					var val = $("#textarea1").html();
  					pContent = turndownService.turndown(val);
  				}
  				var pId = $("#pId").val();
		        ...
		        var url = "${pageContext.request.contextPath}/admin/updatePage.action";
		        var data = {
		        			"pId":pId,
		        ...
		        $.post(url,data,function(msg){
		        	if(msg=="true"){
		        		...
		        		location.href="${pageContext.request.contextPath}/admin/pageManager.action";
		        	}
		        });
			}
		...
		function returnList(){
			...
			$("#pageManager",window.parent.document).addClass("active");
		}
